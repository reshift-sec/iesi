...
public class ScriptRestExecutor extends ScriptExecutor {

    public ScriptRestExecutor(int threadSize) {
        super(threadSize);
    }

    public void execute(ScriptExecutionRequest scriptExecutionRequest) throws MetadataDoesNotExistException, ScriptExecutionBuildException, MetadataAlreadyExistsException {
