...
public class MetadataRepositoryOperation {
    ...
    public void loadMetadataRepository(List<MetadataRepository> metadataRepositoryList) throws IOException {
        loadMetadataRepository(metadataRepositoryList, "");
    }

    public void loadMetadataRepository(List<MetadataRepository> metadataRepositories, String input) throws IOException {
